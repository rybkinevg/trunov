...
class Posts extends Transfer
{
    ...
    protected static function set_tv_shows()
    {
        /**
         * (400) Телепередачи
         * - (401) С участием Людмилы Айвар
         * - (402) С участием Игоря Трунова
         */

        // Остановился на Домашнее насилие: как остановить тиранов
        // http://trunov.com/teleperedachi_s_uchastiem/ljudmila_ajvar/?p=2
        ...
        $ids = [
            ...
            '17830',
            '16520',
            '14488', // пытается скачать какойто файл на странице
